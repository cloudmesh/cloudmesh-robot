...
operating system, please find alternative ways to install these tools.
Let us know how you installed the tools on Linux or Windows and we will
integrate it into our instalation.

Please note that some of the tools require root access and thus you must
be able to have ccess to sudo to run them from our tool.
...
-  https://github.com/ricbra/dotfiles/blob/master/bin/setup\_osx
